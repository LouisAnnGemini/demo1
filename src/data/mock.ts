...
export const allStaffs = [
  ...
  },
  {
    ...
    entity: '上海A商场',
    brand: '周大福',
    healthCert: '有效 (2026-11-11)',
    status: '已入职',
    entryTime: '2024-02-15',
    resignCert: '-',
    resignTime: '-',
    resignReason: '-',
    isBlacklisted: false,
    blacklistReason: '-',
    attachments: ['身份证.pdf', '健康证.jpg', '入职登记表.pdf', '劳动合同.pdf']
  },
  {
    id: 'EMP008',
    name: '郑十',
  ...
  },
  {
    ...
    entity: '上海A商场',
    brand: '雅诗兰黛',
    healthCert: '有效 (2027-01-20)',
    status: '已入职',
    entryTime: '2023-11-11',
    resignCert: '-',
    resignTime: '-',
    resignReason: '-',
    isBlacklisted: false,
    blacklistReason: '-',
    attachments: ['身份证.pdf', '健康证.jpg', '入职登记表.pdf', '银行卡.jpg']
  },
  {
    id: 'EMP010',
    name: '陈十二',
